...
| **스탭(디자이너) 사진** | `assets/staff-01.jpg`, `staff-02.jpg`, `staff-03.jpg` | **파일명만 정확히 맞춰서 GitHub의 assets 폴더에 업로드하면 자동으로 반영됩니다.** (없으면 "STAFF" 텍스트로 자동 대체) 이름·직책을 바꾸려면 `index.html`의 `.team__card` 부분을 수정하세요. |
